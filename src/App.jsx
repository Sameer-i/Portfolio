...
const App = () => {
  ...
  const windowsMetadata = {
    ...
    skills: {
      ...
      content: <Skills />,
      items: ["JavaScript (ES6+)", "Java", "SQL", "HTML5", "CSS3/SCSS", "React.js", "jQuery", "Bootstrap", "REST APIs", "MVC Architecture", "Salesforce Commerce Cloud (SFCC)", "ContentStack CMS", "Mocha", "Chai", "SonarQube", "Git", "GitLab", "JIRA"]
    },
    projects: {
      title: "Projects",
      ...
      content: <Projects />,
      items: ["Hotel Management Dashboard", "TalentBridge: Job Portal", "React.js", "Supabase", "Java", "JSP", "MySQL"]
    },
    experience: {
      title: "Experience",
      ...
      content: <Experience />,
      items: ["Associate Software Engineer", "Accenture", "Bose Corporation", "Software Engineer Intern", "Full-stack"]
    },
    education: {
      title: "Education",
      ...
      content: <Education />,
      items: ["GITAM University", "MCA", "BCA", "Visakhapatnam", "Computer Applications"]
    },
    contact: {
      title: "Contact",
      ...
      content: <Contact />,
      items: ["Phone: 8309577610", "Email: sameershaik12252003@gmail.com", "LinkedIn: linkedin.com/in/sameer98", "GitHub: github.com/sameer-i"]
    },
    help: {
          ...
          <div className="relative">
            ...
            {isAppleMenuOpen && (
              <div className="absolute top-8 left-0 w-[240px] bg-white/90 backdrop-blur-[50px] border border-white/40 rounded-[12px] shadow-2xl p-1 z-[200] text-[#1d1d1f] font-medium animate-in fade-in zoom-in-95 duration-150">
                <div className="px-4 py-1.5 hover:bg-black/5 rounded-md cursor-default" onClick={() => toggleWindow('about')}>About Sameer</div>
          ...
          {[
            {
              ...
              items: [
                ...
                { label: "Get Info", onClick: () => { toggleWindow('about'); window.open('/Sameer-Resume.pdf', '_blank'); } }
              ]
            },
            {
              label: "Edit", items: [
            ...
            },
            {
              label: "Help", items: [
                ...
                { label: "Contact Developer", onClick: () => window.location.href = 'mailto:sameershaik12252003@gmail.com' }
              ]
            }
          ].map(menu => (
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <div className="flex items-center gap-3 p-2 bg-[#007AFF] rounded-xl text-white shadow-md">
                        ...
                        <span className="text-[12px] font-bold">Sameer's iPhone</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            >
              <div className="bg-white/50 backdrop-blur-md rounded-2xl p-3 border border-white/40 shadow-sm mb-3 flex items-center gap-4 hover:bg-white/60 transition-colors">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[11px] text-[#86868b] font-bold">Engineering Active</span>
                </div>
              </div>
      ...
      {!isDockHidden && (
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-[200] animate-in slide-in-from-bottom duration-500">
          <div className="bg-white/15 backdrop-blur-[40px] border border-white/20 rounded-[34px] p-3 flex items-center gap-3.5 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.6)] ring-1 ring-white/10">
            ...
            <a href="https://github.com/sameer-i" target="_blank" rel="noopener noreferrer" className="w-14 h-14 bg-black/40 backdrop-blur-2xl border border-white/10 rounded-[18px] flex items-center justify-center shadow-lg hover:-translate-y-5 hover:scale-[1.3] transition-all group relative border-white/20">
