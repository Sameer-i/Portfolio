...
const Contact = ({ searchQuery = "", viewMode = "list" }) => {
    const contacts = [
        { label: "Phone", icon: <Phone className="w-4 h-4" />, bg: "bg-[#34C759]", link: "tel:8309577610", external: false },
        { label: "Email", icon: <Mail className="w-4 h-4" />, bg: "bg-[#007AFF]", link: "mailto:sameershaik12252003@gmail.com", external: false },
        { label: "LinkedIn", icon: <Linkedin className="w-4 h-4" />, bg: "bg-[#0077B5]", link: "https://linkedin.com/in/sameer98", external: true },
        { label: "GitHub", icon: <Github className="w-4 h-4" />, bg: "bg-[#1d1d1f]", link: "https://github.com/sameer-i", external: true }
    ];
